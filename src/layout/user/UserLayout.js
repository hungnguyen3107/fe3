...
const UserLayout = () => {
    ...
    const { dataProducts, calculateTotalQuantity, calculateTotalPrice, isDataCart } = useCartContext();
                                    ...
                                    <div class={`dropdown cart-dropdown type2 off-canvas mr-0 mr-lg-2 ${isCart ? "opened" : ""}`}>
                                        ...
                                        <div class="dropdown-box">
                                            ...
                                            <div class="cart-action">
                                                <NavLink to="/cart" class="btn btn-dark btn-link">View Cart</NavLink>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6 col-sm-4 col-md-4 col-lg-3">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><a href="shop-category%2bproducts.html">Category + Products</a>
                                                                </li>
